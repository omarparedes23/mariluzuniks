...
async function getProduct(id: string): Promise<Producto | null> {
  const res = await fetch(`/admin/api/products/${id}`, { cache: 'no-store' })
...
export default function EditProductPage({ params }: EditProductPageProps) {
  ...
  // This is a client component, so we need to fetch data differently
  // For now, we'll use a simpler approach with server component wrapper
